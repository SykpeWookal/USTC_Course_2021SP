...
Insert Into Book Values ('b13', 'T4name', 'T4author', 1, 0);
...
insert into Reader value('r6', '无借书读者测试', 100, '无借书读者测试');
...
insert into Borrow value('b4', 'r5', '2020-04-10', NULL);
        ...
        /*T4测试专用*/
insert into Borrow value('b13', 'r1', '2021-04-15', NULL);
insert into Borrow value('b13', 'r2', '2020-01-15', '2021-1-1');